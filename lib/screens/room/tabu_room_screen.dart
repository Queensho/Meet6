...
class _TabuRoomScreenState extends State<TabuRoomScreen> {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              shape: BoxShape.circle,
              boxShadow: [BoxShadow(color: navy.withOpacity(.05), blurRadius: 12)],
            ),
            child: IconButton(
              onPressed: () => Navigator.of(context).pop(),
              icon: const Icon(Icons.arrow_back_rounded, color: navy, size: 29),
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text(
                        'TABU',
                        style: TextStyle(color: lime, fontWeight: FontWeight.w900, fontSize: 13),
                      ),
                    ),
                  ],
                ),
                ...
                const Text(
                  '6 kişi · Kelimelerle eğlen',
                  style: TextStyle(color: Color(0xFF8D93A6), fontSize: 12.5, fontWeight: FontWeight.w700),
                ),
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                Stack(
                  ...
                  children: [
                    _avatar(p, radius: 28, ring: active),
                    Positioned(
                      right: -1,
                      bottom: 2,
                      child: Container(
  ...
  Widget _narratorCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: const Color(0xFF162B77).withOpacity(.10), blurRadius: 18, offset: const Offset(0, 8))],
      ),
      child: Column(
        children: [
          Container(
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                SizedBox(width: 10),
                Expanded(
                  child: Text('İpucu: Kelimeyi anlatırken yasaklı kelimeleri ve bunların köklerini kullanmamaya dikkat et.', style: TextStyle(color: Colors.white, fontSize: 11.5, height: 1.35, fontWeight: FontWeight.w700)),
                ),
              ],
            ),
          ),
  ...
  Widget _guesserCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: lime.withOpacity(.28), borderRadius: BorderRadius.circular(22)),
      child: Row(
        children: [
          const CircleAvatar(backgroundColor: navy, child: Icon(Icons.campaign_rounded, color: lime)),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('$narrator anlatıyor', style: const TextStyle(color: navy, fontSize: 17, fontWeight: FontWeight.w900)),
                const SizedBox(height: 3),
                const Text('Sadece tahminini yaz. Hedef ve yasaklı kelimeler sana gösterilmez.', style: TextStyle(color: Color(0xFF70778B), fontSize: 11.5, fontWeight: FontWeight.w700)),
              ],
            ),
          ),
        ],
        ...
        if (i == messages.length) {
          return Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: const Color(0xFFE9FFD1), borderRadius: BorderRadius.circular(14)),
              child: const Row(mainAxisSize: MainAxisSize.min, children: [
                Icon(Icons.check_circle_rounded, color: Color(0xFF67D83A), size: 20),
                SizedBox(width: 7),
                Text('Doğru tahmin için\ndevam edin!', style: TextStyle(color: navy, fontSize: 11, fontWeight: FontWeight.w800)),
              ]),
            ),
          );
        }
        if (i == messages.length + 1) {
          return Align(
            ...
            child: Container(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 13, vertical: 10),
              decoration: BoxDecoration(color: const Color(0xFFF0ECFF), borderRadius: BorderRadius.circular(14)),
              child: const Row(mainAxisSize: MainAxisSize.min, children: [
                Icon(Icons.group_rounded, color: Color(0xFF583DF2), size: 20),
                SizedBox(width: 7),
                Text('Sadece tahmin yazın,\nsohbet etmeyin.', style: TextStyle(color: Color(0xFF4938C8), fontSize: 11, fontWeight: FontWeight.w800)),
              ]),
            ),
          );
        }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Flexible(child: Text(narratorMsg ? '$name (Anlatıyor)' : name, overflow: TextOverflow.ellipsis, style: TextStyle(color: narratorMsg ? const Color(0xFF2563EB) : navy, fontSize: 12.5, fontWeight: FontWeight.w900))),
                        const SizedBox(width: 8),
                        Text(m['time']?.toString() ?? '', style: const TextStyle(color: Color(0xFFA5A9B7), fontSize: 11)),
                      ],
                    ),
                    const SizedBox(height: 4),
                    Container(
                      ...
                      child: Text(m['text']?.toString() ?? '', style: const TextStyle(color: navy, fontSize: 13.5, height: 1.3, fontWeight: FontWeight.w600)),
                    ),
                  ],
                ),
              ),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: const BorderSide(color: Color(0xFFFFA3AA)),
            ...
            Expanded(
              child: Column(
                children: [
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: const TextStyle(color: Color(0xFFA7ACBC), fontSize: 12.5, fontWeight: FontWeight.w700),
                        filled: true,
                        fillColor: const Color(0xFFF5F6FA),
                        contentPadding: const EdgeInsets.symmetric(horizontal: 14),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: const BorderSide(color: Color(0xFFDDE1EA))),
                        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: const BorderSide(color: Color(0xFFDDE1EA))),
                        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: const BorderSide(color: Color(0xFFC9D0DE))),
                      ),
                    ),
                  ),
                  const SizedBox(height: 5),
                  Align(
                    alignment: Alignment.centerRight,
                    child: Text('${input.text.length}/${narrator ? 200 : 80}', style: const TextStyle(color: Color(0xFF9AA0B0), fontSize: 10.5)),
                  ),
                ],
              ),
            ),
        ...
        Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(30),
              boxShadow: [BoxShadow(color: navy.withOpacity(.18), blurRadius: 36, offset: const Offset(0, 18))],
            ),
            child: Column(
              ...
              children: [
                Container(
                  width: 92,
                  height: 92,
                  decoration: const BoxDecoration(color: Color(0xFFDFFF85), shape: BoxShape.circle),
                  child: const Icon(Icons.check_rounded, color: Color(0xFF42C957), size: 58),
                ),
