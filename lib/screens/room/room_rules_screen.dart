...
class _RoomRulesScreenState extends State<RoomRulesScreen> {
  ...
  static const games = <_GameInfo>[
    ...
    _GameInfo(
      ...
      subtitle: '6 soru • 15 sn seçim • 2 dk tartışma',
  ...
  void initState() {
    ...
    if (!games.any((g) => g.id == selectedGame && g.active)) {
      selectedGame = 'two_truths_one_lie';
    }
        ...
        SnackBar(
          content: Text(
            voiceMode
                ...
                : 'Mini oyun odaları 15 dakikadır.',
          ),
        ),
      );
      return;
      ...
      builder: (sheetContext) => SafeArea(
        ...
        child: Container(
          margin: EdgeInsets.only(
            top: MediaQuery.of(sheetContext).size.height * .16,
          ),
                          ...
                          onTap: () {
                            if (!game.active) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    '${game.title} yakında aktif olacak.',
                                  ),
                                ),
                              );
                              return;
  ...
  IconData get _searchIcon => voiceMode
      ? Icons.mic_rounded
      : gameMode
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(22),
          border: selected
              ? Border.all(color: Colors.white.withOpacity(.72), width: 1.5)
              : null,
        ),
        child: Row(
          children: [
