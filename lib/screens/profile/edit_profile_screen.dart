...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  static const interestOptions = [
    'Kahve', 'Spor', 'Seyahat', 'Müzik', 'Sinema', 'Oyun', 'Yemek', 'Doğa', 'Teknoloji', 'Kitap'
  ];
  ...
  void initState() {
    ...
    cityController = TextEditingController(text: i.city);
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Stack(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              nameController.text.trim().isEmpty ? 'M' : nameController.text.trim()[0].toUpperCase(),
                              style: const TextStyle(color: AppColors.lime, fontSize: 38, fontWeight: FontWeight.w900),
                            ),
                          ),
                          Positioned(
                            right: -2,
                            ...
                            child: InkWell(
                              onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Fotoğraf seçici backend aşamasında bağlanacak.')),
                              ),
                              child: Container(
                                width: 36,
                                height: 36,
                                ...
                                child: const Icon(Icons.camera_alt_rounded, size: 18, color: AppColors.navy),
                              ),
                            ),
                          ),
                        ],
                    ...
                    TextField(
                      ...
                      decoration: meet6InputDecoration(hint: 'Adın', icon: Icons.person_outline_rounded),
                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextField(
                                ...
                                onChanged: (_) => setState(() {}),
                                decoration: meet6InputDecoration(hint: '28', icon: Icons.cake_outlined),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextField(
                                ...
                                onChanged: (_) => setState(() {}),
                                decoration: meet6InputDecoration(hint: 'İstanbul', icon: Icons.location_on_outlined),
                              ),
                            ],
                          ),
                        ),
                    ...
                    TextField(
                      ...
                      maxLines: 4,
                      onChanged: (_) => setState(() {}),
                      decoration: meet6InputDecoration(hint: 'Kendini anlat...', icon: Icons.notes_rounded),
                    ),
                    ...
                    DropdownButtonFormField<String>(
                      value: prompt,
                      isExpanded: true,
                      decoration: meet6InputDecoration(hint: 'Soru seç', icon: Icons.chat_bubble_outline_rounded),
                      items: promptOptions.map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
                    ...
                    TextField(
                      ...
                      maxLength: 80,
                      onChanged: (_) => setState(() {}),
                      decoration: meet6InputDecoration(hint: 'Cevabın', icon: Icons.edit_note_rounded),
                    ),
                    ...
                    Wrap(
                      ...
                      children: [
                        for (final item in const ['Kadınlar', 'Erkekler', 'Herkes'])
                          SelectChip(label: item, selected: lookingFor == item, onTap: () => setState(() => lookingFor = item)),
                      ],
                    ),
                    const SizedBox(height: 18),
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Text('$distanceKm km', style: const TextStyle(color: AppColors.blue, fontWeight: FontWeight.w900)),
                      ],
                    ),
                    Slider(
                      ...
                      max: 100,
                      divisions: 19,
                      onChanged: (value) => setState(() => distanceKm = value.round()),
                    ),
                    ...
                    Wrap(
                      ...
                      runSpacing: 8,
                      children: [
                        for (final item in const ['Ciddi ilişki', 'Flört', 'Yeni insanlarla tanışma', 'Akışına bırakıyorum'])
                          SelectChip(label: item, selected: purpose == item, onTap: () => setState(() => purpose = item)),
                      ],
                    ),
                    const SizedBox(height: 24),
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: const Text('Değişiklikleri kaydet', style: TextStyle(fontWeight: FontWeight.w900)),
                      ),
                    ),
                  ],
                ),
