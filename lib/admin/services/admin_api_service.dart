...
class AdminApiService {
  ...
  static Future<Map<String, dynamic>> users({
    ...
    final uri = Uri(path: '/api/admin/users', queryParameters: {
      'search': search,
      'status': status,
      'page': '$page',
      'limit': '$limit',
  ...
  static Future<Map<String, dynamic>> userDetail(String userId) =>
      _request('GET', '/api/admin/users/$userId');

  static Future<Map<String, dynamic>> moderationHistory(String userId) =>
      _request('GET', '/api/admin/users/$userId/moderation-history');
  ...
  static Future<Map<String, dynamic>> removePhoto(String userId, String photoUrl) =>
      _request(
        'POST',
        '/api/admin/users/$userId/remove-photo',
